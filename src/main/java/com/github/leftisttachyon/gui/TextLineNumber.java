...
public final class TextLineNumber extends JPanel
     ...
     * width will be based on 3 digits, right justified.
     *
     * @param component the related text component
     */
    public TextLineNumber(JTextComponent component) {
        this(component, 3, RIGHT_ALIGNMENT);
    }
     ...
     * @param alignment            the text alignment of this component
     */
    ...
    /**
     * Creates a line number component for a text component.
     *
     * @param component the related text component
     * @param alignment the text alignment of this component
     */
    public TextLineNumber(JTextComponent component, float alignment) {
    ...
    public void setBorderGap(int borderGap) {
        ...
        setBorder(new CompoundBorder(
                digitAlignment == LEFT_ALIGNMENT ? OUTER_LEFT : OUTER_RIGHT, inner));
        lastDigits = 0;
        setPreferredWidth();
    }
     ...
     * </ul>
     *
     * @param digitAlignment some alignment property
     */
